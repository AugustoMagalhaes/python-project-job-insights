...
from src.insights import (filter_by_industry, filter_by_job_type,
                          filter_by_salary_range, get_max_salary,
                          get_min_salary, get_unique_industries,
                          get_unique_job_types)
from src.jobs import read
from src.more_insights import (build_jobs_urls, get_int_from_args, get_job,
                               slice_jobs)
...
def job(index):
    ...
    return render_template("job.jinja2", job=job), 200
